...
class APISpec(object):
    ...
    def path(
        ...
        **kwargs
        ...
        self.clean_operations(operations, self.openapi_version.major)
        ...
        if parameters:
            parameters = self.clean_parameters(parameters, self.openapi_version.major)
    ...
    def clean_parameters(self, parameters, openapi_major_version):
        ...
        return [self.get_ref("parameter", p, openapi_major_version) for p in parameters]

    def clean_operations(self, operations, openapi_major_version):
        """Ensure that all parameters with "in" equal to "path" are also required
        as required by the OpenAPI specification, as well as normalizing any
        ...
        invalid = {
            ...
            - set(VALID_METHODS[openapi_major_version])
        ...
        for operation in (operations or {}).values():
            if "parameters" in operation:
                operation["parameters"] = self.clean_parameters(
